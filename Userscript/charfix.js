setTimeout(() => {
    ...
    if (t && this.characterEntity) {
      for (
        var i = this.characterEntity.model.material.clone(),
          a = this.app.assets.find(e),
          s = this.characterEntity.model.meshInstances,
          o = 0;
        o < s.length;
        ++o
      ) {
      ...
      this.app.assets.load(a),
        a.ready(function (t) {
          (i.diffuseMap = a.resource), i.update();
        });
    }
  };
  Enemy.prototype.setCharacterSkin = function (t, i, e) {
    ...
    for (var n in this.skins) {
      var a = this.skins[n];
      this.skin == a.name
        ? ((a.enabled = !0), (this.characterEntity = a))
        : (a.enabled = !1);
    }
    "Lilium" == this.skin
      ? ((this.hammerEntity.enabled = !0), (this.katanaEntity.enabled = !1))
      : "Shin" == this.skin &&
        ((this.hammerEntity.enabled = !1), (this.katanaEntity.enabled = !0)),
      e && this.setDanceAnimation(this.skin, e),
      i && ((this.heroSkin = i), this.setHeroSkin()),
